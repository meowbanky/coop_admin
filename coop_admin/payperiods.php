                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    <?php echo htmlspecialchars($link['PayrollPeriod']); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo htmlspecialchars($link['InsertedBy']); ?>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500">
                                    <?php echo date('M d, Y', strtotime($link['DateInserted'])); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button onclick="viewPeriod(<?php echo $thisperiod; ?>)"
                                        class="text-blue-600 hover:text-blue-900 transition-colors" title="View Period">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button onclick="closePeriod(<?php echo $thisperiod; ?>)"
                                        class="text-red-600 hover:text-red-900 transition-colors" title="Close Period">
            ...
            <form id="viewPeriodForm" method="post" action="assets/classes/controller.php?act=activateclosedperiod">
                <div class="px-6 py-4">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-800">
                                        Please confirm you would like to reactivate this <strong>CLOSED</strong> period
                                        to <strong>VIEW</strong> data.
                    ...
                    <div>
                        ...
                        <input type="text" id="periodDisplay" disabled
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-500">
                        <input type="hidden" id="reactivatePeriodId" name="reactivateperiodid">
                    </div>
                </div>
                <div class="px-6 py-4 bg-gray-50 rounded-b-lg flex justify-end space-x-3">
                    <button type="button" onclick="closeViewPeriodModal()"
                        class="px-4 py-2 text-gray-700 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors">
                        Cancel
                    </button>
                    <button type="submit"
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <form id="closePeriodForm" method="post" action="assets/classes/controller.php?act=closeActivePeriod">
                <div class="px-6 py-4">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-red-800">
                                        Please confirm you would like to close the period below. Ensure you have
                                        completed all transactional changes and processing for the current month.
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Period</label>
                        <input type="text" id="currentPeriodDisplay" disabled
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-500">
                    </div>
                </div>
                <div class="px-6 py-4 bg-gray-50 rounded-b-lg flex justify-end space-x-3">
