    ...
    <form method="GET" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="employee.php" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition-colors">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">CoopID</th>
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            <button onclick="deleteEmployee(<?= $employee['id'] ?>, '<?= htmlspecialchars($employee['FirstName'] . ' ' . $employee['LastName']) ?>')" 
...
class EmployeeManager {
    ...
    async confirmDelete(id) {
        try {
            ...
            if (result.success) {
                CoopUtils.showSuccess('Employee deleted successfully!');
                location.reload();
            } else {
                CoopUtils.showError(result.message || 'Failed to delete employee');
            }
        } catch (error) {
            console.error('Error:', error);
            CoopUtils.showError('An error occurred while deleting employee');
        }
    }
}
