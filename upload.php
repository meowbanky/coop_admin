            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden fade-in">
                ...
                <form id="uploadForm" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="flex justify-end space-x-4">
                        <button type="button" id="resetForm" class="px-6 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                            <i class="fas fa-undo mr-2"></i>Reset
                        </button>
                        <button type="submit" id="uploadBtn" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
