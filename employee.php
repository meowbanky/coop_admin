            ...
            <form id="addEmployeeForm" class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="add_coop_id" value="<?= htmlspecialchars($nextCoopID) ?>" readonly
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                        <p class="text-xs text-gray-500 mt-1">Assigned automatically when the member is saved.</p>
                    </div>
                    <div>
...
class EmployeeManager {
    ...
    editEmployee(employee) {
        ...
        document.getElementById('edit_position').value = employee.JobPosition || '';
        document.getElementById('edit_address').value = employee.StreetAddress || '';
    ...
    async addEmployee() {
        ...
        try {
            ...
            if (result.success) {
                CoopUtils.showSuccess(
                    result.coop_id
                        ? `Employee added successfully! CoopID: ${result.coop_id}`
