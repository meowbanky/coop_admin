            ...
            <form id="addUserForm">
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div id="selectedStaff" class="hidden p-3 bg-blue-50 rounded-lg">
                        <p class="text-sm text-blue-800"><strong>Selected:</strong> <span id="selectedStaffName"></span>
                        </p>
...
class UserManager {
    ...
    updatePagination() {
        ...
        if (this.currentPage > 1) {
            pagination +=
                `<button onclick="userManager.loadPage(${this.currentPage - 1})" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Previous</button>`;
        }

        // Next button
        if (this.currentPage < this.totalPages) {
            pagination +=
                `<button onclick="userManager.loadPage(${this.currentPage + 1})" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Next</button>`;
        }
        ...
        for (let i = 1; i <= this.totalPages; i++) {
            if (i === this.currentPage) {
                pagination +=
                    `<button class="relative inline-flex items-center px-4 py-2 border border-blue-500 bg-blue-50 text-sm font-medium text-blue-600">${i}</button>`;
            } else {
                pagination +=
                    `<button onclick="userManager.loadPage(${i})" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">${i}</button>`;
            }
        }
